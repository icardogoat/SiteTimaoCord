...
import { Bot, Home, Megaphone, Menu, Receipt, Server, Settings, ShoppingBag, Star, Table, Ticket, Trophy, Users } from "lucide-react"
...
const navGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/admin/standings", label: "Tabelas", icon: Table },
    ]
  },
  {
